...
def _confirmInit():
    while True:
        ...
        if c == 'Y' or c == 'y':
            ...
            #####
            New_nginx = _NginxInit(vip_host, real_ip, exclude_opts, info)
